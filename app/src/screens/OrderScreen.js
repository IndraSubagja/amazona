...
export default function OrderScreen({ match }) {
  ...
  }, [dispatch, successPay, orderId, order, sdkReady]);
          ...
          <div className="card card-body">
            <ul>
              ...
              <li>
                <div className="row">
                  <div>Items</div>
                  <div>${optimizePrice(order.itemsPrice)}</div>
                </div>
              </li>
              <li>
                <div className="row">
                  <div>Shipping</div>
                  <div>${optimizePrice(order.shippingPrice)}</div>
                </div>
              </li>
              <li>
                <div className="row">
                  <div>Tax</div>
                  <div>${optimizePrice(order.taxPrice)}</div>
                </div>
              </li>
              <li>
                <div className="row">
                  ...
                  <div>
                    <strong>${optimizePrice(order.totalPrice)}</strong>
                  </div>
                </div>
              </li>
              {!order.isPaid && (
